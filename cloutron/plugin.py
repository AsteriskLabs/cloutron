...
class PluginManager(object):
    ...
    def register_plugin(self, plugin):
        ...
        #     if cloutron.debugger:
        #         cloutron.debugger.register_command_plugin(plugin.name, plugin.command_class)
        else:
...
class CloutronPlugin(Plugin):
    @classmethod
    def initialise(cls):
        pass


class APIPlugin(CloutronPlugin):
    """
...
class DebuggerAdaptorPlugin(CloutronPlugin):
    """
...
class ViewPlugin(CloutronPlugin):
    """
...
# class WebPlugin(CloutronPlugin):
#     """
...
# class CommandPlugin(CloutronPlugin):
#     """
